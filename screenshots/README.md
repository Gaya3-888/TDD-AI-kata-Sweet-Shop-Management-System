...
5. **Screenshot 5.png** - Admin panel inventory management
6. **Screenshot 6.png** - User dashboard with sweet catalog
7. **Screenshot 7.png** - User dashboard showing stock reduction on cart add
